 ...
 */
final class Version20251212123523 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE icon ADD icon_color VARCHAR(7) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE icon DROP icon_color');
    }
}
